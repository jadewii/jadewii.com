...
console.log('🔧 REBUILDING GEAR FILE FROM SCRATCH')

// Create a minimal, clean gear file with just Sequential products
const cleanGearData = [
  // Sequential Products
  {
...
const fileContent = `export const gear = ${JSON.stringify(cleanGearData, null, 2)}
`

// Write the clean file
fs.writeFileSync('lib/data/gear.js', fileContent)

console.log('✅ CLEAN GEAR FILE CREATED!')
console.log(`📝 Added ${cleanGearData.length} Sequential products`)